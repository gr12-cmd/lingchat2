export default {
  ...
  data: {
    export: {
      title: 'データエクスポート',
      hint: 'バックアップに含める項目を選択し、ZIP ファイルとしてエクスポートします。',
      button: 'エクスポート開始',
    },
    import: {
      title: 'バックアップインポート',
      hint: '以前にエクスポートした ZIP バックアップファイルを選択し、復元する項目を選んでください。',
      pickFile: 'バックアップファイルを選択',
      appVersion: 'アプリバージョン',
      exportedAt: 'エクスポート日時',
      selectItems: '復元する項目を選択',
      button: 'インポート開始',
    },
    items: {
      database: 'データベース（キャラクター/セーブ/会話履歴/メモリ）',
      settings: 'Tauri 設定（LLM/ツール/アプリ設定）',
      frontendPreferences: 'フロントエンド設定（テキスト/オーディオ/表示/ショートカット）',
    ...
    deselectAll: 'すべて解除',
    exporting: 'エクスポート中...',
    exportRunning: 'データを圧縮中...',
    exportSuccess: 'エクスポート成功',
    exportFailed: 'エクスポート失敗',
    importing: 'インポート中...',
    importRunning: 'データを復元中...',
    importSuccess: 'インポート成功',
    importFailed: 'インポート失敗',
    preparingExport: '準備中...',
    cancelled: 'キャンセル済み',
    restartHint: 'データベースまたは設定が復元されました。新しいデータを読み込むにはアプリを再起動してください。',
    restartNow: '今すぐ再起動',
    restartLater: '後で',
  },
}
