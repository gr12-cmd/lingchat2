...
export default {
  ...
  data: {
    export: {
      title: 'Export Data',
      hint: 'Select items to include in the backup, then export as a ZIP file.',
      button: 'Start Export',
    },
    import: {
      title: 'Import Backup',
      hint: 'Select a previously exported ZIP backup file and choose items to restore.',
      pickFile: 'Select Backup File',
      appVersion: 'App Version',
      exportedAt: 'Exported At',
      selectItems: 'Select items to restore',
      button: 'Start Import',
    },
    items: {
      database: 'Database (characters/saves/chat records/memories)',
      settings: 'Tauri Config (LLM/tools/app settings)',
      frontendPreferences: 'Frontend Preferences (text/audio/display/shortcuts)',
    ...
    exporting: 'Exporting...',
    exportRunning: 'Packing data...',
    exportSuccess: 'Export Successful',
    exportFailed: 'Export Failed',
    importing: 'Importing...',
    importRunning: 'Restoring data...',
    importSuccess: 'Import Successful',
    importFailed: 'Import Failed',
    preparingExport: 'Preparing...',
    cancelled: 'Cancelled',
    restartHint: 'Database or settings have been restored. Please restart the app to load the new data.',
