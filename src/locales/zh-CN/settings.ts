export default {
  ...
  data: {
    export: {
      title: '导出数据',
      hint: '选择要包含在备份中的项目，然后导出为一个 ZIP 文件。',
      button: '开始导出',
    },
    import: {
      title: '导入备份',
      hint: '选择一个之前导出的 ZIP 备份文件，选择要恢复的项目。',
      pickFile: '选择备份文件',
      appVersion: '应用版本',
      exportedAt: '导出时间',
      selectItems: '选择要恢复的项目',
      button: '开始导入',
    },
    items: {
      database: '数据库（角色/存档/对话记录/记忆）',
      settings: 'Tauri 配置（LLM/工具/应用设置）',
      frontendPreferences: '前端偏好（文字/音频/显示/快捷键）',
      characters: '角色文件',
      backgrounds: '背景图片',
      musics: '音乐',
      ambients: '环境音',
    ...
    deselectAll: '全不选',
    exporting: '正在导出...',
    exportRunning: '正在打包数据...',
    exportSuccess: '导出成功',
    exportFailed: '导出失败',
    importing: '正在导入...',
    importRunning: '正在恢复数据...',
    importSuccess: '导入成功',
    importFailed: '导入失败',
    preparingExport: '正在准备...',
    cancelled: '已取消',
    restartHint: '已恢复数据库或设置，请重启应用以加载新数据。',
    restartNow: '立即重启',
    restartLater: '稍后',
  },
}
